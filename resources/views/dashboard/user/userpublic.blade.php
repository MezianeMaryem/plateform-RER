...
<html lang="en">
    <head>
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <title>UTBM Public documents</title>
        <style>
...
<script>
    ...
    <body>
        ...
        <div class="center-content logo">
            <img src="{{ asset('images/public.jpeg') }}" alt="Logo" />
        </div>
        <div class="center-content">
            <h1>Hello, here you can find RER's documents ! </h1>
            <br>
            <form action="{{ route('user.userpublic') }}" method="GET">
